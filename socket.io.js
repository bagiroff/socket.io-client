/*! Socket.IO.js build:0.9.17, development. Copyright(c) 2011 LearnBoost <dev@learnboost.com> MIT Licensed
  socket.io library without flash object, modification added:
    * XHRPolling.prototype.get -> xhr.send wrapped in timeout
    * swfobject -> var swfobject;
    * removed all swfobject properties references
    * 
 */
...
(function (exports, io, global) {
  ...
  XHRPolling.prototype.get = function () {
    ...
    setTimeout(function() {
      self.xhr = self.request();
      if (global.XDomainRequest && self.xhr instanceof XDomainRequest) {
        self.xhr.onload = onload;
        self.xhr.onerror = onerror;
      } else {
        self.xhr.onreadystatechange = stateChange;
      }
      self.xhr.send(null);
    }, 10);
  };
